...
bool MultipleLabelCcBacktrackCpu<State>::checkConstraint(
  ...
  if (remainingLength == 1) {
    ...
    #ifndef OPTIMIZATION_USE_EARLY_TERMINATION
...
MultipleLabelCcBacktrackCpu<State>::compute(
  ...
  circularConstraintIterator = circularConstraintVector.erase(circularConstraintIterator);
...
template<class State>
void MultipleLabelCcBacktrackCpu<State>::setConstraintVector(
...
template<class State>
void MultipleLabelCcBacktrackCpu<State>::setConstraintIterator(const size_t &index) {
  circularConstraintIterator = circularConstraintVector.cbegin()+index;
}
template<class State>
std::vector <MultipleLabelConstraintCircular>* MultipleLabelCcBacktrackCpu<State>::getConstraintVector() {
