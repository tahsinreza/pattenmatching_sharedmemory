...
template<class State>
void MultipleLabelTdsBacktrackCpu<State>::setConstraintVector(
...
template<class State>
void MultipleLabelTdsBacktrackCpu<State>::setConstraintIterator(const size_t &index) {
  templateConstraintIterator = templateConstraintVector.cbegin()+index;
}

template<class State>
std::vector <MultipleLabelConstraintTemplate>* MultipleLabelTdsBacktrackCpu<State>::getConstraintVector() {
