...
MultipleLabelConstraintCircular::MultipleLabelConstraintCircular()
  : length(0) {
...
bool MultipleLabelConstraintCircular::operator==(const MultipleLabelConstraintCircular &other) const {
  return (length == other.length) && (vertexIndexVector == other.vertexIndexVector);
}

void MultipleLabelConstraintCircular::print(std::ostream &ostream) const {
