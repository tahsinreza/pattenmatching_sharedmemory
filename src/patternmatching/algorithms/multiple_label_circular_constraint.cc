...
bool MultipleLabelCircularConstraint::operator==(const MultipleLabelCircularConstraint &other) const {
  return (length == other.length) && (vertexIndexVector == other.vertexIndexVector);
}

void MultipleLabelCircularConstraint::print(std::ostream &ostream) const {
